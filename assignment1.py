...
def day_count(start_date: str, stop_date: str) -> int:
    ...
    while current_date != after(stop_date):
        ...
        day = day_of_week(int(str_year), int(str_month), int(str_day))
...
def date_compare(date1: str, date2: str) -> bool:
    "return True if date1 is earlier than or equal to date2"

    str_year1, str_month1, str_day1 = date1.split('-')
    str_year2, str_month2, str_day2 = date2.split('-')

    date_num1 = int(str_year1 + str_month1 + str_day1)
    date_num2 = int(str_year2 + str_month2 + str_day2)
...
if __name__ == "__main__":
    ...
    if date_compare(first_date, second_date):
